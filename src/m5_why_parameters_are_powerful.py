...
def main():
    ...
    #even_better_draw_circles(rg.Point(100, 50), 3, 15, 'blue', 1)
    #even_better_draw_circles(rg.Point(-200, 0), 15, 3, 'green', 3)

    even_better_draw_circles(rg.Point(100, 100), 10, 30, 'red', 1)
    even_better_draw_circles(rg.Point(100, -100), 10, 30, 'purple', 1)
    even_better_draw_circles(rg.Point(-100, 100), 10, 30, 'blue', 1)
    even_better_draw_circles(rg.Point(-100, -100), 10, 30, 'green', 1)
...
def better_draw_circles(point,r_increase):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(r_increase)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(r_increase * k)  # Radius r_increase, 2*r_increase ...
...
def even_better_draw_circles(point,r_increase,num,color,thick):
